...
\title{Évaluation des apports d'un GAN pour une classification semi-supervisé de textes français faiblement labellisés}

% a short form should be given in case it is too long for the running head
\titlerunning{Apports d'un GAN dans une classification semi-supervisé}
...
\begin{abstract}
Les tâches de classifications de textes se heurtent souvent au problèmes de base de données peu voir pas labellisé. Ici nous nous intéressons au apports de l'ajout d'un GAN afin d'artificiellement créer des données labellisés. Le but est d'améliorer les performances d'un classifieur qui ne se serait entraîné que sur des données labellisé issue d'une petite base de données.
...
\section{Comparaisons}\label{references}
